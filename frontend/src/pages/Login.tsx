  ...
  return (
    <div className="space-y-6">
      <div className="text-center lg:text-left">
        ...
        <p className="text-surface-600 mt-2">Acesse sua conta para gerenciar o sistema.</p>
      </div>
      ...
      <form onSubmit={handleSubmit(handleLogin)} className="space-y-4">
        <div>
          ...
          <input 
            {...register('email')}
            type="email"
            className="w-full px-4 py-2 rounded-lg border border-surface-200 focus:ring-2 focus:ring-brand-500 outline-none transition-all"
